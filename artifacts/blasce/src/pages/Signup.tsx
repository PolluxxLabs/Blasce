...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await signup(form.displayName, form.email, form.password);
      navigate("/");
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-[52%] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div>
            ...
            <span className="text-white/35 text-sm">— Martin Scorsese</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 lg:px-16">
        ...
        >
          ...
          <h1 className="text-3xl font-display font-bold text-white mb-1.5">Create your account</h1>
          <p className="text-white/40 text-sm mb-8">Join Blasce and start watching today.</p>
